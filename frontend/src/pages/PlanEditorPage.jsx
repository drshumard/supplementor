...
function MonthPage({
  ...
  return (
    <div className="rounded-2xl border border-border/40 bg-white shadow-sm mb-10 overflow-hidden"
      ...
      {/* Column headers */}
      <div className="grid items-center px-8 py-4 border-b border-border/30 bg-[#FAFBFB]"
        style={{
  ...
  return (
    <div className="p-10 max-w-[1560px] mx-auto">
      ...
      <div className="rounded-2xl border border-border/40 bg-white shadow-sm mb-8 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-8 py-4 border-b border-border/30 bg-[#FAFBFB]">
        ...
        <div className="px-8 py-8 text-center">
          <Input
            ...
            className="text-4xl font-bold border-none bg-transparent h-auto focus-visible:ring-0 focus-visible:ring-offset-0 tracking-[-0.03em] text-center w-full max-w-[600px] mx-auto"
